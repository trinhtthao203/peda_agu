...
class TranslatePathController extends Controller
{
    ...
    static function getPath($path='') {
        ...
        if($ds) {
            if($ds['collection'] == 'thong_tin') {
                if($locale == 'vi') return 'en/detail-news-and-events/'. $ds['slug_en'];
                else return 'vi/chi-tiet-thong-tin/'.$ds['slug_vi'];
            } else if($ds['collection'] == 'dm_thong_tin') {
                if($locale == 'vi') return 'en/news-and-events/'. $ds['slug_en'];
                else return 'vi/tin-tuc-su-kien/'.$ds['slug_vi'];
            } else {
