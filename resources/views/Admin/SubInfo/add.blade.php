...
@section('body')
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('admin-sub-info-create', [app()->getLocale()]) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" name="ten" id="input-ten" class="form-control" required
                                placeholder="Ví dụ: Bộ môn Toán" value="{{ old('ten') }}">
                        </div>
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="text" name="slug" id="input-slug" class="form-control"
                                placeholder="Ví dụ: bo-mon-toan" value="{{ old('slug') }}">
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            <label class="font-weight-bold text-gray-700"><i class="fab fa-youtube text-danger"></i> Link
                                Video YouTube</label>
                            <input type="text" name="video_ytb" class="form-control"
                                placeholder="https://www.youtube.com/watch?v=... hoặc https://youtu.be/..."
                                value="{{ old('video_ytb') }}">
                            <small class="text-muted">Hệ thống sẽ tự động tách mã nhúng Embed Video.</small>
                        </div>
                        <div class="col-md-4 form-group mb-3">
                            <label class="font-weight-bold text-gray-700"><i class="far fa-image text-success"></i> Ảnh bìa
                                trang (Tùy chọn)</label>
                    ...
                    <div class="card mb-4 border">
                        <div
                            ...
                            <span><i class="fas fa-paperclip"></i> Tệp đính kèm (Attachments)</span>
                            <button type="button" class="btn btn-sm btn-outline-primary" id="btn-add-file">+ Thêm
                                tệp</button>
                        </div>
                        <div class="card-body" id="attachment-container">
                            <div class="row align-items-center mb-2 attachment-row">
                                <div class="col-md-5">
                                    <input type="text" name="file_title[]" class="form-control form-control-sm"
                                        placeholder="Tiêu đề hiển thị của tệp...">
                                </div>
                                <div class="col-md-6">
                                    <input type="file" name="file_dinhkem[]"
                                        class="form-control-file border p-1 rounded bg-light">
                                </div>
        ...
        function updateQuickSelect() {
            ...
            if (type === 'nhan-su') {
                ...
                departmentsData.forEach(function(item) {
                    ...
                    $select.append(
                        `<option value="${item._id}" data-name="${name}" data-slug="${slug}">${name}</option>`);
                });
