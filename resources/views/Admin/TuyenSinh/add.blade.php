...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/tuyen-sinh/thong-tin" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('Thêm mới Thông tin Tuyển sinh') }}</h3>
            <form action="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/tuyen-sinh/thong-tin/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 switchery-demo">
                            Published:&nbsp;&nbsp;&nbsp;
                            <input type="checkbox" name="published" id="published" class="js-switch" data-plugin="switchery" checked="checked" data-color="#009efb" value="1"/>
                        </div>
                    </div>
