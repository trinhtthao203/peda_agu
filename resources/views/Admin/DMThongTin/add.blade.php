...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/danh-muc-thong-tin" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> {{ __('Thêm mới') }} {{ __('Danh mục Thông tin') }}</h3>
            <form action="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/danh-muc-thong-tin/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" id="ten" name="ten" class="form-control" placeholder="{{ __('Tiêu đề') }}" value="{{ old('ten') }}" required />
                        </div>
                    </div>
                    <div class="form-group row">
