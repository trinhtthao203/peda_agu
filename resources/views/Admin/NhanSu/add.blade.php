            ...
            <div class="card-body">
                <form action="{{ route('admin-nhan-su-create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <ul class="nav nav-tabs mb-4" id="langTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active font-weight-bold" id="vi-tab" data-toggle="tab" href="#vi"
                                role="tab">🇻🇳 Tiếng Việt</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-bold" id="en-tab" data-toggle="tab" href="#en"
                                role="tab">🇬🇧 English</a>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="text" name="chuyen_nganh" class="form-control"
                                        placeholder="Ví dụ: Toán học, Giáo dục học, Ngữ văn..."
                                        value="{{ old('chuyen_nganh') }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" name="ho_ten_en" class="form-control"
                                        placeholder="e.g. Dr. Nguyen Van A" value="{{ old('ho_ten_en') }}">
                                </div>
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="text" name="hoc_ham_hoc_vi_en" class="form-control"
                                        placeholder="e.g. Assoc. Prof., Ph.D" value="{{ old('hoc_ham_hoc_vi_en') }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    ...
                                    <input type="text" name="chuyen_nganh_en" class="form-control"
                                        placeholder="e.g. Mathematics, Education, Literature..."
                                        value="{{ old('chuyen_nganh_en') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <input type="email" name="email" class="form-control" required
                                placeholder="username@agu.edu.vn" value="{{ old('email') }}">
                        </div>
                        <div class="col-md-6 form-group mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group mb-4">
                            ...
                            <input type="file" name="hinh_anh"
                                class="form-control-file border p-2 w-100 rounded bg-light" accept="image/*">
                        </div>
                        <div class="col-md-6 form-group mb-4">
                            <label class="font-weight-bold text-gray-700">Tệp đính kèm Lý lịch khoa học (.pdf)</label>
                            <input type="file" name="ly_lich_khoa_hoc"
                                class="form-control-file border p-2 w-100 rounded bg-light" accept=".pdf">
                        </div>
                    </div>
