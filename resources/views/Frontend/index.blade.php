...
<section class="typo-dark" id="home-new">
    <div class="container">
        @if($thong_tin_tuyen_sinh && count($thong_tin_tuyen_sinh) > 0)
        <div class="row">
            <div class="col-12">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="font-size:22px;font-weight:bold;"><i class="glyphicon glyphicon glyphicon-education"></i> {{ __('Thông tin Tuyển sinh 2026') }}</h3>
                    </div>
                    <div class="panel-body">
                        <ul class="list-news-home-ts">
                            @foreach($thong_tin_tuyen_sinh as $ts)
                                <li><a href="https://tuyensinh.agu.edu.vn/tin-tuc/{{ $ts['slug'] }}" target="_blank">{{ $ts['title'] }}</a></li>
                            @endforeach
                        </ul>
                        <a href="https://tuyensinh.agu.edu.vn" class="btn btn-primary pull-right"><i class="uni-paper-plane"></i> {{ __('Xem thêm') }}</a>
                    </div>
                </div>
            </div>
        </div>
