...
<div class="page-default typo-dark">
    <div class="container">
        <div class="blog-single-details">
            <h4>Giới thiệu về Trường Đại học An Giang 25 năm phát triển</h4>
            <p class="text-center">
                <video controls poster="{{ env('APP_URL') }}assets/frontend/images/poster.png" style="width:100%">
                    <source src="{{ env('APP_URL') }}/assets/frontend/videos/AGU_25_nam_phat_trien.mp4" type="video/mp4">
                </video>
            </p>
            <h4>Giới thiệu về Trường Đại học An Giang 20 năm phát triển</h4>
            <p class="text-center">
                <video controls poster="{{ env('APP_URL') }}assets/frontend/images/poster.png" style="width:100%">
                    <source src="{{ env('APP_URL') }}/assets/frontend/videos/AGU_INTRO_2023.mp4" type="video/mp4">
                </video>
            </p>
