                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="sub-menu menu-border">
                                <li>
                                    <span class="mega-menu-sub-title">{{ __('KHOA SƯ PHẠM, ĐẠI HỌC QUỐC GIA TPHCM TRƯỜNG ĐẠI HỌC AN GIANG ') }}</span>
                                    <ul class="sub-menu">
                                        ...
                                        {{-- -<li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/gioi-thieu/hoi-dong-truong">Hội đồng trường</a>
                                </li> --}}
                                ...
                                {{-- <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/gioi-thieu/chien-luoc-phat-trien">Chiến lược phát triển</a>
            </li>--}}
            {{-- <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/gioi-thieu/brochure">Brochure Trường Đại học An Giang</a>
    </li> --}}
</ul>
</li>
</ul>
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                {{-- <li><a href="https://docs.agu.edu.vn/tracuucongvan/" target="_blank">Công văn</a></li>
                                        <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/gioi-thieu/bieu-mau">Các biểu mẫu</a>
        </li> --}}
    ...
    <ul class="sub-menu menu-border">
        <li>
            ...
            <ul class="sub-menu">
                ...
                @endforeach
                {{-- <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/tin-tuc-su-kien/tuyen-sinh">Tuyển sinh</a>
        </li>
                    ...
                    {{-- <div class="col-md-4">
                            <ul class="sub-menu menu-border">
                                <li class="has-sub">
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/tuyen-sinh">Thông tin Tuyển sinh</a>
        </li>
                        ...
                        <ul class="sub-menu menu-border">
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="http://ffl.agu.edu.vn/" target="_blank">Khoa Ngoại ngữ</a></li>
                                    <li><a href="http://fac.agu.edu.vn/" target="_blank">Khoa Du lịch và Văn hóa - Nghệ thuật</a></li>
