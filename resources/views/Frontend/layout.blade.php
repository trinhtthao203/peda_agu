...
<head>
    <!-- Basic -->
    <meta charset="utf-8">
    <title>@yield('title', __('Khoa Sư phạm')) - {{ __('Khoa Sư phạm') }}</title>
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v13.0&appId=131376384294659&autoLogAppEvents=1" nonce="xz8OBKsp"></script> --}}
    ...
    <div id="pageloader">
        <div class="loader-inner">
            <img src="{{ env('APP_ASSETS') }}assets/frontend/images/preloader.gif" alt="Khoa sư phạm - Trường Đại học An Giang">
        </div>
    </div><!-- Page Loader -->
    <!-- Back to top -->
    <a href="#0" class="cd-top" style="display: flex; align-items: center; justify-content: center;">
        <i class="fa fa-chevron-up" style="color: #fff; font-size: 20px;"></i>
    </a>
    <!-- Header Begins -->
            ...
            <div class="container">
                <nav>
                    <ul class="nav nav-pills nav-top">
                        <li class="phone">
                            <span><i class="fa fa-envelope"></i>peda@agu.edu.vn</span>
                        </li>
                        <li class="phone">
            ...
            <div class="footer-content">
                ...
                <div class="footer-info">
                    <p>
                        ...
                        Email: <a href="mailto:peda@agu.edu.vn">peda@agu.edu.vn</a><br>
