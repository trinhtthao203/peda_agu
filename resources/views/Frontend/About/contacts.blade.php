...
@section('title', __('About - Website editorial board of An Giang University'))
@section('body')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="contact-info">
                            ...
                            <h5 class="title">{{ __('Website editorial board of An Giang University') }}</h5>
                            <p><strong>{{ __('Address: No 18, Ung Van Khiem street, Long Xuyen ward, An Giang province') }}</strong></p>
                        </div><!-- Contact Info -->
                    </div><!-- Column -->
                </div>
            </div>
