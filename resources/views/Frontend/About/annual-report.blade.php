...
@section('title', __('About - Annual Report'))
@section('body')
        ...
        <div class="blog-single-details">
            ...
            <div class="tab">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#nam2020" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="true">Year 2020</a></li>
                    <li role="presentation" class=""><a href="#nam2019" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false">Year 2019</a></li>
                    <li role="presentation" class=""><a href="#nam2017_2018" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false">Year 2017-2018</a></li>
                    <li role="presentation" class=""><a href="#nam2016" aria-controls="profile" role="tab" data-toggle="tab" aria-expanded="false">Year 2016</a></li>
                    <li role="presentation" class=""><a href="#nam2015" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false">Year 2015</a></li>
                </ul>
                <!-- Tab panes -->
